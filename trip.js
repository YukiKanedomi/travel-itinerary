  ...
  days: [
    ...
    { n:2, date:'9/21', wd:'月', title:'メルボルン到着、カフェの街へ',
      ...
      sched:[
        ...
        { t:'18:00', h:'ディナー — Chin Chin', d:'モダンタイの人気店。予約不可の行列制だが回転は早い。辛さ調整可（mildで）。17:30に着くと待ちが短い',
    ...
    { n:3, date:'9/22', wd:'火', title:'マーケットと世界遺産と図書館',
      ...
      sched:[
        ...
        { t:'21:00', h:'ホテル帰着', d:'明日は移動日。VA859のオンラインチェックイン（24時間前から・座席24A/24B）を済ませて早めに就寝' }
      ],
      ...
      sched:[
        ...
        { t:'17:25', h:'シドニー T2着 → 市内へ', d:'Uber約30分・$50〜65。電車ならAirport Link',
          ...
          tips:[
            ...
            '電車：Museum駅まで約15分・$19.44/人（空港駅利用料込み）。乗り換えなしで行け、駅からホテルは徒歩3〜4分',
    ...
    { n:6, date:'9/25', wd:'金', title:'ハーバーの街を歩き尽くす最終日',
      ...
      sched:[
        ...
        { t:'11:30', h:'ロックス地区', d:'石畳の歴史地区。金曜はフーディー・マーケットで屋台つまみ食い。9月は「Unlock The Rocks」で金曜夜20:30まで延長営業',
...
var PICKS = {
  ...
  manly:    { g:'view', name:'マンリー行きフェリー', tip:'乗船自体が絶景。往復だけでも価値あり。9月は労働争議で欠航・遅延の可能性、当日transportnsw.infoで確認', map:'https://maps.google.com/?q=Circular+Quay+Ferry+Wharf+Sydney' },
  bondi:    { g:'view', name:'ボンダイ→ブロンテ海岸ウォーク', tip:'2.5kmの絶景遊歩道。午前スタートで半日', map:'https://maps.google.com/?q=Bondi+Beach+Sydney' },
  watsons:  { g:'view', name:'ワトソンズベイ＆The Gap', tip:'フェリーで行ける断崖。夕日が見事。9月はフェリーの争議で欠航の可能性あり', map:'https://maps.google.com/?q=The+Gap+Watsons+Bay+Sydney' },
