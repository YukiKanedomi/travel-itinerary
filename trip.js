...
var TRIP = {
  ...
  days: [
    ...
    { n:6, date:'9/25', wd:'金', title:'ハーバーの街を歩き尽くす最終日',
      ...
      voucher:null,
      sched:[
        { t:'7:30', h:'朝食 — ホテルの Amber Restaurant', d:'朝食付き。ロビー階、部屋番号を言うだけ。今日は歩く日なのでしっかり' },
{ t:'9:00', h:'QVB とストランド・アーケードで本気のお土産', d:'開店直後が空いている。T2の紅茶・Haigh\'s・R.M.Williams はQVB、Aesop はストランド・アーケード。買った物は一度ホテルへ', sv:{ lat:-33.87165, lng:151.20640, label:'QVB（George St側）', from:{ lat:-33.87165, lng:151.20700 }, note:'George St 側の砂岩の外壁。ステンドグラスのアーチ窓が並ぶ列に入口の扉がある。ヒルトンの真向かいで、道を渡ればすぐ' },
          map:'https://maps.google.com/?q=Queen+Victoria+Building+455+George+Street+Sydney', web:'https://www.qvb.com.au/',
          tips:['Woolworths Metro Town Hall（Park St・徒歩2分）で Tim Tam・Byron Bay Cookies・Twinings もこの流れで','注意｜TRS（10%還付）は同じ店で合計300ドル以上のレシートが対象。レシートは1か所にまとめる'] },
        { t:'11:15', h:'ホテルに戻って荷物を置く', d:'買った物はスーツケースへ。手ぶらで午後へ' },
        { t:'11:45', h:'Town Hall 駅 → Circular Quay', d:'電車で2駅・5分。Museum からでも同じ' },
        { t:'12:00', h:'ロックス — 金曜フードマーケットでランチ', d:'9〜15時の屋台市。座りたければ The Glenmore の屋上（96 Cumberland St）',
          map:'https://maps.google.com/?q=The+Rocks+Markets+Sydney', web:'https://www.therocks.com/' },
        { t:'13:15', h:'Dawes Point — 橋を真下から', d:'Hickson Rd の先の芝生。ハーバーブリッジを見上げ、対岸にオペラハウス。マーケットから徒歩5分、10分で戻れる',
          map:'https://maps.google.com/?q=Dawes+Point+Park+Sydney' },
        { t:'13:45', h:'オペラハウス', d:'サーキュラー・キーの東岸を歩いて階段を上り、建物の足元まで。タイルは白とクリームの2色。午後は順光でいちばんきれいに写る',
          map:'https://maps.google.com/?q=Sydney+Opera+House', web:'https://www.sydneyoperahouse.com/' },
        { t:'15:10', h:'Wharf 3 からマンリー行きフェリー（F1）', d:'20分おき・片道30分。港の入口まで出る「いちばん安い遊覧船」。行きは右側のデッキで橋とオペラハウス',
          map:'https://maps.google.com/?q=Circular+Quay+Wharf+3',
          tips:['乗る前に桟橋の電光掲示で運航を確認（9月は争議で欠航・遅延あり）。読み取り機が切られていれば無料、動いていればタップ','公営が止まっていたら Manly Fast Ferry（民間・20分・片道約14ドル）で','外デッキは風が強い。上着を'] },
        { t:'15:40', h:'マンリー', d:'桟橋から Corso の歩行者天国を5分でビーチ。右手の遊歩道を Shelly Beach まで往復40分。時間があれば',
          map:'https://maps.google.com/?q=Manly+Beach' },
        { t:'17:10', h:'帰りの船 — 日没を港の上で', d:'日没17:47。港に入るころ、橋とオペラハウスが夕焼けのシルエットになる。左側のデッキへ',
          tips:['帰りの便が減っていたら Manly Fast Ferry で戻る'] },
        { t:'17:45', h:'サーキュラー・キー着 → Opera Bar へ', d:'桟橋から東へ徒歩5分' },
{ t:'18:30', h:'ディナー — Opera Bar', d:'オペラハウス直下の絶景テラス。予約不要。ピザ＋モクテルで最後の夜に乾杯', sv:{ lat:-33.8573, lng:151.2146, label:'オペラハウス下のコンコース（Opera Bar）', from:{ lat:-33.85777, lng:151.21419 }, note:'オペラハウス前の広場から。左手の海沿い、一段低いコンコースに Opera Bar のテラスが広がる。階段で降りる' },
        ...
        { t:'20:30', h:'Circular Quay → Museum 駅、Coles で明朝の分', d:'電車8分。朝食は間に合わないので、パンと飲み物を買って部屋へ' },
        { t:'21:30', h:'完全パッキング', d:'明日は5:40発。スーツケースを仕上げる。空港へは Museum 駅から T8（Airport & South Line）で International まで13分' }
      ],
