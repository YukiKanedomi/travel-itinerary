    ...
    { n:1, date:'9/20', wd:'日', title:'成田を発って、南半球へ',
      ...
      sched:[
        { t:'10:53', h:'橋本駅発 — 京王線 新宿行き（台風対策で前倒し）', d:'橋本始発なので座れる。新宿まで45分・409円。雨が強まる前に成田へ',
          ...
          tips:[
            'N\'EXの指定席は購入済み（チケットレス・25号に変更済み）。当日券売機に並ばない',
            '逃したら10:49発の快速（新宿11:44着）か11:0x発。N\'EXは12:38発（27号）にも空席あり',
            '京王が止まったら控え：JR横浜線で横浜へ → N\'EX横浜発（4,370円）' ] },
        { t:'12:08', h:'N\'EX 25号 新宿発 → 空港第2ビル', d:'約75分・空港第2ビル 13:23着でT2直結。指定席（えきねっとで変更済み）',
          tips:[
    ...
    { n:2, date:'9/21', wd:'月', title:'メルボルン到着、カフェの街へ',
      ...
      sched:[
        ...
        { t:'7:00', h:'SkyBusで市内へ', d:'真っ赤な2階建て。全便サザンクロス駅行き・約30分。チケットはKKdayで購入済み（QRバウチャー）',
          steps:[
            'T2を出た歩道の赤い「SkyBus」看板へ。KKdayのメールのQRバウチャー（PDF）を運転手に見せる。券売機に並ばなくてよい',
