  ...
  days: [
    ...
    { n:6, date:'9/25', wd:'金', title:'ハーバーの街を歩き尽くす最終日',
      ...
      sched:[
        ...
        { t:'13:15', h:'ハーバーブリッジを歩いて渡る', d:'Argyle St の階段（Argyle Stairs）で Cumberland St に上がり、歩道へ。片道20分で対岸の Milsons Point。無料。途中の Pylon Lookout（200段・約25ドル）は任意',
          map:'https://maps.google.com/?q=Sydney+Harbour+Bridge+Pedestrian+Walkway+Cumberland+Street',
          tips:['風が強い日は帽子を手に。写真は手すりの隙間から','渡った先の Kirribilli の岸からオペラハウスを正面に。ルナパークの顔の門もすぐ'] },
        { t:'14:15', h:'Milsons Point 駅 → Circular Quay', d:'電車で1駅。橋を歩いて戻るより早い' },
        { t:'14:30', h:'オペラハウス', d:'階段を上って建物の足元まで。タイルは白とクリームの2色。午後は順光でいちばんきれいに写る',
          map:'https://maps.google.com/?q=Sydney+Opera+House', web:'https://www.sydneyoperahouse.com/' },
        { t:'15:30', h:'王立植物園をゆっくり', d:'無料。ウォレマイ・パイン（柵の中の針葉樹）とロリキートの群れ。海沿いの道を東へ',
          map:'https://maps.google.com/?q=Royal+Botanic+Garden+Sydney', web:'https://www.rbgsyd.nsw.gov.au/' },
        { t:'17:15', h:'ミセス・マッコリーズ・ポイントで夕日', d:'日没17:47。オペラハウスと橋が夕焼けのシルエットになる。シドニー最後の一枚はここで',
          map:'https://maps.google.com/?q=Mrs+Macquarie%27s+Chair+Sydney' },
        { t:'18:00', h:'海沿いを戻って Opera Bar へ', d:'植物園の海沿いの道を西へ徒歩20分' },
        ...
        { t:'21:30', h:'完全パッキング・Uber を予約', d:'明日は5:40発。スーツケースを仕上げ、Uber アプリで5:35のピックアップを予約しておく' }
      ],
