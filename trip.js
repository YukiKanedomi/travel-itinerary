  ...
  days: [
    { n:1, date:'9/20', wd:'日', title:'成田を発って、南半球へ',
      ...
      sched:[
        { t:'12:14', h:'橋本駅発 — 京王線 新宿行き', d:'橋本始発なので座れる。新宿まで44分・409円',
          steps:[
            '12:14発の新宿行きに乗車（各停表示だが途中から速くなる直通。橋本始発）',
            '12:58 新宿着。京王線改札を出てJR南口方面へ',
            'N\'EXまで40分の余裕。スーツケース連れでもゆっくり。N\'EXは5・6番線',
            'この40分で昼食（南口改札内のコンビニで十分）とトイレを済ませる。次に落ち着いて食べられるのは成田の16時' ],
          tips:[
            'N\'EXの指定席は購入済み（チケットレス・4号車1番C/D席）。当日券売機に並ばない',
            '逃したら12:34発（新宿13:18頃着・N\'EXまで20分）が最終ライン',
            '京王が止まったら控え：JR横浜線で横浜へ → N\'EX横浜発（4,370円）' ] },
        { t:'13:38', h:'N\'EX 31号 新宿発 → 空港第2ビル', d:'約76分・空港第2ビル 14:54着でT2直結。指定席 4号車1番C/D（購入済み）',
          tips:[
            '注意｜降りるのは「空港第2ビル」（14:54着）。終点「成田空港」（14:59着）はT1なので乗り過ごさない',
            '特急券はチケットレス（何も見せなくてよい）。運賃は別なのでSuicaのまま改札を通る',
            '乗り遅れても14:08発（15:23着）で間に合う。焦らない',
            '荷物は座席背後のスペースか荷物置場へ。ワイヤー錠が付けられる' ] },
        { t:'14:54', h:'成田空港 第2ターミナル着', d:'空港第2ビル駅からT2直結。JALカウンターでチェックイン・荷物預け・Wi-Fi受取',
    ...
    { n:2, date:'9/21', wd:'月', title:'メルボルン到着、カフェの街へ',
      ...
      sched:[
        ...
        { t:'7:00', h:'SkyBusで市内へ', d:'真っ赤な2階建て。全便サザンクロス駅行き・約30分・$25.90/人',
          steps:[
            'T2を出た歩道の赤い「SkyBus」看板へ。チケットは赤い券売機（タッチ決済）かアプリ',
