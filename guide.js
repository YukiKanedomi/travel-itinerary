...
/* ---- 現地の作法ハンドブック ---- */
var GUIDE_HB = [
  { art:'coffee', title:'カフェの注文 — 「コーヒーください」は通じない',
  ...
  { art:null, title:'レストランの会計 — チップは不要',
  ...
  { art:null, title:'スーパー攻略 — コンビニは当てにしない',
  ...
  { art:null, title:'トイレ — 「困ったらコンビニ」が使えない国',
  ...
  { art:null, title:'治安 — 気をつけるのはメルボルン',
  ...
  { art:'magpie', title:'マグパイ — 9月だけ空から来る',
  ...
  { art:'binchicken', title:'ビンチキン — シドニーの愛される嫌われ者',
...
function renderGuidePage() {
  ...
  GUIDE_HB.forEach(function(k){
    h += '<div class="kb-card gd-card">' + gdArt(k.art) +
      '<div class="kb-title">' + k.title + '</div><div class="kb-body">' + k.body + '</div></div>';
  });
