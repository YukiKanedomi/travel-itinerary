...
var TRIP = {
  ...
  flights: [
    { id:'JL773', kicker:'JAL INTERNATIONAL — OUTBOUND',
      ...
      ex:[
        ...
        'モバイルバッテリーは1人2個まで・機内では本体の充電もスマホへの給電も不可（JAL 2026/4/24〜）。機内充電は座席のUSBで',
    ...
    { id:'VA859', kicker:'VIRGIN AUSTRALIA — DOMESTIC',
      ...
      ex:[
        ...
        '受託 1人1個23kg／機内持込は8kgのバッグ1個＋座席下の小物1個（重い物は着る）',
    ...
    { id:'JL52', kicker:'JAL INTERNATIONAL — INBOUND',
      ...
      ex:[
        '6:00にT1着 → JALカウンターで荷物預け（シドニー空港の推奨は国際線3時間前）',
  ...
  days: [
    { n:1, date:'9/20', wd:'日', title:'成田を発って、南半球へ',
      ...
      voucher:null,
      sched:[
        { t:'10:53', h:'橋本駅発 — 京王線 新宿行き（台風対策で前倒し）', d:'橋本始発なので座れる。新宿まで45分・409円。雨が強まる前に成田へ',
          steps:[
        ...
        { t:'12:08', h:'N\'EX 25号 新宿発 → 空港第2ビル', d:'約75分・空港第2ビル 13:23着でT2直結。指定席 10号車 2番A/B（変更済み）',
          tips:[
            '注意｜降りるのは「空港第2ビル」（13:23着）。終点「成田空港」はT1なので乗り過ごさない',
            '特急券はチケットレス（何も見せなくてよい）。運賃は別なのでSuicaのまま改札を通る',
            '乗り遅れても12:38発（13:53着）・13:08発で十分間に合う。焦らない',
            '荷物は座席背後のスペースか荷物置場へ。ワイヤー錠が付けられる' ] },
        { t:'13:23', h:'成田空港 第2ターミナル着', d:'空港第2ビル駅からT2直結。JALカウンターでチェックイン・荷物預け・Wi-Fi受取',
          map:'https://maps.google.com/?q=Narita+International+Airport+Terminal+2', web:'https://www.narita-airport.jp/',
          steps:[
            'まず第2ターミナル<b>3階</b>の「JWiFi&Mobileカウンター」でWi-Fiルーターを受取（07:00-21:00）',
            'カウンターが混んでいたら、受取メールの「法人会員優先レーン」の案内を係員に見せる',
            '第2ターミナル出発ロビー（3階）の「JAL国際線チェックインカウンター」へ。中央エリアに大きな表示あり',
            'パスポートと予約確認メール（QRコード）を提示してチェックイン・荷物預け',
            '保安検査 → 出国審査の順で通過。17:00には保安検査の列へ（ゲート集合は18:10）。夕食は検査後の制限エリアで',
            '搭乗開始30分前を目安にゲートへ' ],
          tips:[
            '液体物は100ml以下の容器＋透明袋1枚に。取り出しやすい場所へ',
            'PC・タブレット・液体は、レーン手前の表示に従う。「出さずにそのまま」の表示（CT型）があれば出さなくてよい。表示がなければ出す',
            '未開封のペットボトルも保安検査で放棄になる。飲み切るか、検査後に買い直す',
            '注意｜Wi-Fiルーターとモバイルバッテリーは機内持込。スーツケースに入れると預けられません',
      ...
      sched:[
        { t:'5:45', h:'メルボルン空港 T2着・入国／検疫', d:'スマートゲート → 荷物受取 → 食品があれば申告レーン（YES）へ',
          ...
          tips:[
            ...
            'SkyBusにトイレはない。到着ホールで済ませてから乗り場へ',
            '到着ホールに出るのが7:00頃なら、以降の予定が30分後ろ倒しになっても問題ない' ] },
        { t:'7:00', h:'SkyBusで市内へ', d:'真っ赤な2階建て。全便サザンクロス駅行き・約30分。チケットはKKdayで購入済み（QRバウチャー）',
          steps:[
            'T2を出て車寄せへ。停留所はT1・T3・T4の前（T2の両隣）なので、赤い「SkyBus」の案内板に沿って隣のターミナル前へ。KKdayのQRバウチャー（PDF・大人2）を係員に見せる。券売機に並ばなくてよい',
            '乗車時にQRチケットをスキャン。スーツケースは車内の荷物ラックへ',
            '約30分で終点サザンクロス駅。「Collins Street」の表示に従って出る',
            'コリンズ通りを東へ1ブロック、King Stを渡った先の右側がホテル（徒歩5分）' ],
          tips:[
            '4:00〜25:00・10〜15分間隔。時刻表は見なくていい',
            '控え：Uber $60〜75（「Rideshare」案内板へ・車種と運転手名を照合）／タクシー $90〜',
            '注意｜州の運賃半額キャンペーンはSkyBusだけ対象外' ] },
        { t:'7:45', h:'インターコンチに荷物預け', d:'チェックインは15時。フロントに荷物を預けて身軽に', sv:{ lat:-37.81825, lng:144.95799, label:'インターコンチネンタル（495 Collins St）の入口', note:'Collins St の南側。黒い庇に金文字の INTERCONTINENTAL が入口の目印。右隣の赤レンガが Rialto の旧館' },
        ...
        { t:'8:15', h:'朝食 — Lune Croissanterie', d:'世界最高峰のクロワッサンとフラットホワイト。早朝到着の今だけ行列前に入れる', sv:{ lat:-37.8156, lng:144.969, label:'Lune CBD（161 Collins St・Russell St側の入口）', note:'Russell St 側。石の庇の下、靴店の左隣が Lune の入口。朝はその左に行列ができるので、列の最後尾に並ぶ' },
          map:'https://maps.google.com/?q=Lune+Croissanterie+CBD+Flinders+Lane+Melbourne', web:'https://www.lunecroissanterie.com/' },
        { t:'10:00', h:'ブロック＆ロイヤル・アーケード', d:'19世紀の優雅なアーケード。床のモザイクが見どころ。旧Hopetoun跡は「The Tea Rooms 1892」として営業中',
          tips:['Hopetoun Tea Roomsは421 Bourke Stへ移転工事中で未開業（2026年末予定）。アーケード内のショーケースの店は別業者「The Tea Rooms 1892」（月〜土 8:00-17:30）','同社のパンなら Hopetoun Bake Shop（20-22 McKillop St・平日9-17時）'],
    ...
    { n:3, date:'9/22', wd:'火', title:'マーケットと世界遺産と図書館',
      ...
      sched:[
        ...
        { t:'9:30', h:'無料トラムで北へ', d:'Elizabeth St北行きの19・57・59番。無料ゾーン内はタッチ不要。City Circle（35番）は10時始発なのでこの時間は来ない' },
        ...
        { t:'17:00', h:'早めのディナー — Cumulus Inc. か Chin Chin', d:'どちらも Flinders Lane で劇場から徒歩5分。ウォークイン、早め入りで待たずに座れる',
          map:'https://maps.google.com/?q=Cumulus+Inc+45+Flinders+Lane+Melbourne', web:'https://www.cumulusinc.com.au/' },
        { t:'19:00', h:'Monty Python\'s Spamalot — Athenaeum Theatre', d:'188 Collins St（Town Hall のトラム停の目の前）。火曜は19:00開演（水曜は13:00と19:30）。2時間15分・休憩あり・21:15終演。チケットは Ticketmaster か劇場窓口（17:30〜）',
        ...
        { t:'21:30', h:'ホテル帰着', d:'Collins St のトラムで10分。明日は移動日。VA859のオンラインチェックイン（16:00から可・座席24A/24B）が済んでいるか確認して、荷造りを8割まで' }
      ],
      ...
      sched:[
        ...
        { t:'17:25', h:'シドニー T2着 → 市内へ', d:'Uber約30分・$50〜65。電車ならAirport Link',
          ...
          steps:[
            ...
            'シティサークル経由のT8で「Museum」駅下車（Centralの次）→ ホテルまで徒歩3〜4分' ],
          tips:[
            'Uber：約25〜30分・$50〜65。スーツケースが多ければこちら',
            '電車：Museum駅まで約15分・約$23/人（空港駅利用料$18.61＋運賃）。乗り換えなしで行け、駅からホテルは徒歩3〜4分',
            'タクシー：空港→CBDは定額$60（2025年11月からの試行）。2人＋荷物ならUberと同額程度で確実',
            'T2は改修工事中（2026年末まで）。到着側の影響は小さいが、案内表示が変わっていることがある' ] },
        { t:'18:15', h:'リッジスにチェックイン', d:'直結のColesで滞在中の水とTimTamを調達', sv:{ lat:-33.87715, lng:151.20755, label:'リッジス ワールドスクエア（389 Pitt St）の入口', note:'Pitt St 側。ガラスの庇の下、ガラス張りのロビーが入口。左隣に Avis／Budget と Hordern Towers の入口があるので混同しない' },
          map:'https://maps.google.com/?q=Rydges+World+Square+389+Pitt+Street+Sydney', web:'https://www.rydges.com/accommodation/sydney-nsw/world-square-sydney-cbd/' },
        { t:'19:30', h:'ダーリングハーバーへ（徒歩10分）', d:'Liverpool St → Darling Driveで徒歩10分。ライトレールは要らない。夜景が映える時間帯',
          map:'https://maps.google.com/?q=Darling+Harbour+Sydney' },
        { t:'20:00', h:'ディナー — Ume Burger（Darling Square店）', d:'和風グルメバーガー。到着夜は気軽に。水曜は16:30〜21:00営業（Darling Exchange 1階・1 Little Pier St）',
          map:'https://maps.google.com/?q=Ume+Burger+Darling+Square+Sydney', web:'https://umeburger.com/' },
        { t:'21:30', h:'サーキュラー・キーの夜景（任意）', d:'ライトアップされたオペラハウスとハーバーブリッジに初対面。移動日で疲れていれば省略（DAY6の夜に同じ景色を見る）',
    ...
    { n:5, date:'9/24', wd:'木', title:'ブルーマウンテンズと動物たちの日',
      ...
      sched:[
        ...
        { t:'8:00', h:'ホテル出発（徒歩10分）', d:'Pitt St北進 → Park St左折 → George St。QVBの斜向かい。8:10着で集合の15分前',
          ...
          tips:[
            '8:00発なら8:10頃着。ロビーのトイレを済ませても集合の5分前に間に合う',
            'Googleマップで「Hilton Sydney」徒歩ナビを使えば迷わない' ] },
        { t:'8:25', h:'ヒルトン ロビー集合', d:'8:30出発。遅刻するとツアーに乗れません', hard:true, sv:{ lat:-33.87182, lng:151.2076, label:'ヒルトン シドニー正面（488 George St・QVBの斜向かい）', from:{ lat:-33.87175, lng:151.20705 }, note:'George St の西側歩道（QVB 側）から見た正面。左上に Hilton のロゴ、ガラス壁の中央の扉が正面入口。集合は入って右手、フロント近くのソファー' },
          tips:[
            '注意｜アラームは2つセット。バウチャー「SYDODOAOPT87」を提示',
            '困ったら現地マイバスデスク 02-9510-0139（平日9-17時・日本語可）／時間外の緊急は +61 438 424 021',
            '乗車時にガイドへ「解散はRydges World Square」と伝える（当日3か所から選ぶ方式）' ] },
        { t:'9:15', h:'フェザーデール動物園（またはシドニー動物園）', d:'コアラと記念撮影・カンガルーに餌やり（抱っこはNSW州で禁止）。餌やり$5・コアラ写真$26は別料金（カード可）。どちらの園かは当日ガイドの案内で',
          map:'https://maps.google.com/?q=Featherdale+Wildlife+Park+Doonside+NSW', web:'https://www.featherdale.com.au/' },
        { t:'11:15', h:'キングス・テーブルランド（リンカーンズ・ロック）', d:'断崖からジャミソン渓谷のパノラマ。プロ撮影データのプレゼントあり',
          tips:[ '時期によりカヒルズ・ルックアウトに変更されることがある（2026年1〜4月は変更されていた）' ] },
        { t:'12:15', h:'エコーポイント展望台', d:'スリーシスターズの大展望。売店とトイレあり', sv:{ lat:-33.7322, lng:150.312, label:'エコーポイント展望台', note:'バスを降りた先の広場。売店（インフォメーション）の右奥に手すりがあり、その先がスリーシスターズの展望台' },
          map:'https://maps.google.com/?q=Echo+Point+Lookout+Katoomba+NSW' },
        { t:'13:00', h:'シーニックワールド＋ランチ（〜14:40）', d:'最大斜度52度のトロッコとガラス底ロープウェイ。昼食はバウチャーで（スパイスを避けシンプルに）',
          map:'https://maps.google.com/?q=Scenic+World+Katoomba+NSW', web:'https://www.scenicworld.com.au/',
          tips:[ '順序はJTBの行程表（動物園 → 展望地 → エコーポイント → シーニックワールド → ルーラ）。当日のガイド判断で前後することがある' ] },
        { t:'15:00', h:'ルーラの街を散策', d:'標高985m。キャンディ店・雑貨・コーヒーブレイク',
          map:'https://maps.google.com/?q=Leura+Mall+NSW+Blue+Mountains' },
        { t:'17:30', h:'ホテル前で解散', d:'リッジスの目の前で降車。M4の渋滞で30分ほど遅れることもある',
          tips:[
    ...
    { n:6, date:'9/25', wd:'金', title:'ハーバーの街を歩き尽くす最終日',
      ...
      sched:[
        ...
        { t:'11:30', h:'ロックス地区', d:'石畳の歴史地区。金曜はフーディー・マーケットで屋台つまみ食い。9月は「Unlock The Rocks」で金曜夜20:30まで延長営業。13:00にランチがあるので、つまみ食いは軽めに',
        ...
        { t:'15:00', h:'QVBで本気のお土産', d:'T2の紅茶・カンガルーグッズ・R.M.Williams。一段上の土産をここで。AesopはQVB内にはなく、188 Pitt St（徒歩3分）', sv:{ lat:-33.87165, lng:151.20640, label:'QVB（George St側）', from:{ lat:-33.87165, lng:151.20700 }, note:'George St 側の砂岩の外壁。ステンドグラスのアーチ窓が並ぶ列に入口の扉がある。ヒルトンの真向かいで、道を渡ればすぐ' },
        ...
        { t:'18:30', h:'ディナー — Opera Bar', d:'オペラハウス直下の絶景テラス。予約不要。ピザ＋モクテルで最後の夜に乾杯', sv:{ lat:-33.8573, lng:151.2146, label:'オペラハウス下のコンコース（Opera Bar）', from:{ lat:-33.85777, lng:151.21419 }, note:'オペラハウス前の広場から。左手の海沿い、一段低いコンコースに Opera Bar のテラスが広がる。階段で降りる' },
          tips:['改装中（9/10時点）。屋内席は閉鎖で屋外ハーバー席とテラスバーのみ営業。夜は冷えるので羽織りを','屋外が満席なら控え：向かいのOpera Kitchenか、サーキュラー・キー側のレストラン街へ'],
    ...
    { n:7, date:'9/26', wd:'土', title:'南十字星に手を振って、帰国',
      ...
      voucher:null,
      sched:[
        { t:'5:00', h:'起床・最終チェック', d:'パスポート・財布・スマホ・充電器。忘れ物は枕元とバスルーム' },
        { t:'5:40', h:'チェックアウト → Uber', d:'空港まで約20分。早朝は道が空いている。配車は前夜にUberで予約しておくと確実' },
        { t:'6:00', h:'T1 JALカウンター＆TRS', d:'空港の推奨は国際線3時間前。チェックイン後、TRS対象があれば保安検査後のカウンターへ', sv:{ lat:-33.93497, lng:151.16587, label:'シドニー空港 T1 出発フロアの車寄せ', note:'T1 出発階の車寄せ。横断歩道を渡って屋根の下へ。JAL のカウンターはターミナルに入って奥' },
          ...
          steps:[
            ...
            'TRS：レシート（$300以上・同一ABN＝同じ店）＋パスポート＋品物を提示 → GST分（税込価格の1/11・約9%）が還付',
            '100mlを超える化粧品や大型品を預け荷物に入れるなら、チェックイン前にランドサイドのABF窓口で先に検査を受ける',
            '出国審査 → 搭乗ゲートへ' ],
          tips:[
            'TRSアプリで事前入力しておくとQR提示で時短',
            '免税品はスーツケースに詰めず、すぐ出せる状態で',
            '注意｜TRSは保安検査通過後のみ。検査前には申請できない',
            'TRSを使わない（同一店$300に届かなかった）なら、保安検査後はそのままゲートへ。7:25の縛りはなくなる' ] },
        ...
        { t:'17:45', h:'羽田 T3着', d:'Visit Japan Webで税関申告 → 荷物受取。おかえりなさい！',
          steps:[
            ...
            '<b>2階到着ロビーの到着出口付近にある返却BOX</b>へWi-Fiルーター一式を返す（24時間可）' ],
          tips:[
            '豪州土産の食品は日本の税関でも申告が必要なケースあり',
            '注意｜Wi-Fiの返却BOXは税関を出た先。疲れて素通りしがちなので、ルーターは手荷物の取り出しやすい位置に',
...
var PICKS = {
  ...
  hutong:   { g:'food', lat:-37.81187, lng:144.9694, name:'HuTong Dumpling Bar', tip:'チャイナタウンの小籠包。サクッと点心', map:'https://maps.google.com/?q=HuTong+Dumpling+Bar+Melbourne' },
  udon:     { g:'food', lat:-37.81272, lng:144.96767, name:'Udon Yasan', tip:'セルフ式讃岐うどん。手頃で早い', map:'https://maps.google.com/?q=Udon+Yasan+Melbourne' },
  lord:     { g:'food', lat:-37.81812, lng:144.96738, name:'Lord of the Fries', tip:'プラントベースのバーガー＆フライ', map:'https://maps.google.com/?q=Lord+of+the+Fries+Melbourne' },
  rolld:    { g:'food', lat:-37.81, lng:144.9626, name:"Roll'd", tip:'バインミーとフォーを気軽に', map:"https://maps.google.com/?q=Roll'd+Melbourne+CBD" },
  patricia: { g:'cafe', lat:-37.8147, lng:144.95829, name:'Patricia Coffee Brewers', tip:'立ち飲みの伝説的エスプレッソバー', map:'https://maps.google.com/?q=Patricia+Coffee+Brewers+Melbourne' },
  brunetti: { g:'cafe', lat:-37.81669, lng:144.96579, name:'Brunetti', tip:'イタリアンカフェ。ケーキで休憩', map:'https://maps.google.com/?q=Brunetti+Melbourne' },
  hardware: { g:'cafe', lat:-37.81208, lng:144.9604, name:'The Hardware Société', tip:'人気ブランチカフェ（Hardware Lane）', map:'https://maps.google.com/?q=The+Hardware+Societe+Melbourne' },
  degraves: { g:'cafe', lat:-37.81756, lng:144.96589, name:'Degraves Street', tip:'路地カフェ街。トースティとコーヒー', map:'https://maps.google.com/?q=Degraves+Street+Melbourne' },
  centrepl: { g:'food', lat:-37.81655, lng:144.96545, name:'Centre Place', tip:'Degraves の向かいの路地。サンドイッチ・トースティの小店が並ぶ', map:'https://maps.google.com/?q=Centre+Place+Melbourne' },
  hwlane:   { g:'food', lat:-37.81260, lng:144.96070, name:'Hardware Lane（パスタ・ピザの路地）', tip:'呼び込みの店が並ぶ。入りやすい店にそのまま', map:'https://maps.google.com/?q=Hardware+Lane+Melbourne' },
  emporium: { g:'food', lat:-37.81180, lng:144.96400, name:'Emporium／Melbourne Central フードコート', tip:'席が取りやすい。和食・アジア・サラダから選べる', map:'https://maps.google.com/?q=Emporium+Melbourne+food+court' },
  grilld:   { g:'food', lat:-37.81540, lng:144.96500, name:"Grill'd（バーガー）", tip:'市内に複数。地図で最寄りを検索', map:"https://maps.google.com/?q=Grill'd+Melbourne+CBD" },
  schnitz:  { g:'food', lat:-37.81300, lng:144.96350, name:'Schnitz（シュニッツェル）', tip:'市内に複数。揚げたてを待つだけ', map:'https://maps.google.com/?q=Schnitz+Melbourne+CBD' },
  gyg:      { g:'food', lat:-37.81450, lng:144.96650, name:'Guzman y Gomez（メキシカン）', tip:'市内に複数。ブリトーとタコス', map:'https://maps.google.com/?q=Guzman+y+Gomez+Melbourne+CBD' },
  colesfed: { g:'food', lat:-37.81770, lng:144.96660, name:'Coles（276 Flinders St）→ Federation Square', tip:'サンドイッチと果物を買って広場のベンチで。いちばん楽', map:'https://maps.google.com/?q=Coles+276+Flinders+Street+Melbourne' },
  manly:    { g:'view', lat:-33.8612, lng:151.2107, name:'マンリー行きフェリー', tip:'乗船自体が絶景。往復だけでも価値あり。9月は労働争議で欠航・遅延の可能性、当日transportnsw.infoで確認', map:'https://maps.google.com/?q=Circular+Quay+Ferry+Wharf+Sydney' },
  bondi:    { g:'view', lat:-33.8907, lng:151.27241, name:'ボンダイ→ブロンテ海岸ウォーク', tip:'2.5kmの絶景遊歩道。午前スタートで半日', map:'https://maps.google.com/?q=Bondi+Beach+Sydney' },
  watsons:  { g:'view', lat:-33.84569, lng:151.28523, name:'ワトソンズベイ＆The Gap', tip:'フェリーで行ける断崖。夕日が見事。9月はフェリーの争議で欠航の可能性あり', map:'https://maps.google.com/?q=The+Gap+Watsons+Bay+Sydney' },
  barangaroo:{ g:'sight', lat:-33.85849, lng:151.20116, name:'バランガルー・リザーブ', tip:'ロックス隣の水辺エリア。散歩に', map:'https://maps.google.com/?q=Barangaroo+Reserve+Sydney' },
  operatour:{ g:'sight', lat:-33.8572, lng:151.21512, name:'オペラハウス内部ツアー', tip:'建築の内側へ。要事前予約', map:'https://maps.google.com/?q=Sydney+Opera+House' },
  chatthai: { g:'food', lat:-33.87912, lng:151.20633, name:'Chat Thai（ヘイマーケット）', tip:'賑わうタイ料理の定番', map:'https://maps.google.com/?q=Chat+Thai+Haymarket+Sydney' },
  harrys:   { g:'food', lat:-33.86925, lng:151.22118, name:"Harry's Cafe de Wheels", tip:'名物ミートパイの屋台', map:'https://maps.google.com/?q=Harrys+Cafe+de+Wheels+Woolloomooloo' },
  pancakes: { g:'food', lat:-33.8584, lng:151.2086, name:'Pancakes on the Rocks', tip:'甘い/食事系パンケーキ。入りやすい', map:'https://maps.google.com/?q=Pancakes+on+the+Rocks+Sydney' },
  spice:    { g:'food', lat:-33.88517, lng:151.20195, name:'Spice Alley', tip:'屋台風アジアン横丁。気軽に食べ歩き', map:'https://maps.google.com/?q=Spice+Alley+Chippendale' },
  chinatown:{ g:'food', lat:-33.87815, lng:151.20402, name:'チャイナタウン（Dixon St）', tip:'餃子・麺・BBQ。遅くまで営業', map:'https://maps.google.com/?q=Dixon+Street+Chinatown+Sydney' },
  bourke:   { g:'cafe', lat:-33.88943, lng:151.21492, name:'Bourke Street Bakery', tip:'定番ベーカリー。ソーセージロール', map:'https://maps.google.com/?q=Bourke+Street+Bakery+Sydney' },
  messina:  { g:'cafe', lat:-33.86213, lng:151.20988, name:'Gelato Messina', tip:'行列必至のジェラート。食後に', map:'https://maps.google.com/?q=Gelato+Messina+Sydney' },
  singleo:  { g:'cafe', lat:-33.88118, lng:151.20968, name:'Single O（Surry Hills）', tip:'シドニー代表のスペシャルティコーヒー', map:'https://maps.google.com/?q=Single+O+Surry+Hills' },
  grounds_alex:{ g:'cafe', lat:-33.91063, lng:151.19428, name:'The Grounds of Alexandria', tip:'庭園カフェの名店。CBDから15分', map:'https://maps.google.com/?q=The+Grounds+of+Alexandria+Sydney' },
  lune:     { g:'cafe', lat:-37.81555, lng:144.96883, name:'Lune Croissanterie（CBD）', tip:'NYタイムズが「世界一かも」と評したクロワッサン。161 Collins St・入口はRussell St側。行列は見た目より速い', map:'https://maps.google.com/?q=Lune+Croissanterie+CBD+Melbourne' },
  pidapipo: { g:'cafe', lat:-37.81743, lng:144.96589, name:'Pidapipó（Degraves St）', tip:'メルボルン代表のジェラート。カフェ路地の食後に', map:'https://maps.google.com/?q=Pidapipo+Degraves+Street+Melbourne' },
  adk:      { g:'food', lat:-37.80739, lng:144.95739, name:'ホットジャムドーナツ（QVM）', tip:'1950年から同じレシピの名物屋台ADK。揚げたて5個$8', map:'https://maps.google.com/?q=American+Doughnut+Kitchen+Queen+Victoria+Market' },
  borek:    { g:'food', lat:-37.8072, lng:144.9585, name:'ボレク屋台（QVM）', tip:'トルコ風の平焼きパン$5前後。ドーナツ前の塩気に', map:'https://maps.google.com/?q=Borek+Bakehouse+Queen+Victoria+Market' },
  pieface:  { g:'food', lat:-33.87764, lng:151.20603, name:'Pie Face（World Square）', tip:'ホテル真下のパイチェーン。小腹・朝ごはんの保険に', map:'https://maps.google.com/?q=Pie+Face+World+Square+Sydney' },
  rocksmkt: { g:'food', lat:-33.85847, lng:151.2083, name:'ロックス・フードマーケット', tip:'金曜10-15時だけの屋台市（串焼き・餃子・菓子）。DAY6はちょうど金曜', map:'https://maps.google.com/?q=The+Rocks+Markets+Playfair+Street+Sydney' },
  larenai:  { g:'cafe', lat:-33.8593, lng:151.20842, name:'La Renaissance（ロックス）', tip:'老舗フランス菓子店。中庭でエクレア休憩。〜16:30', map:'https://maps.google.com/?q=La+Renaissance+Patisserie+The+Rocks+Sydney' }
};
