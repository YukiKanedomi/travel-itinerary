...
var PREP_TODO = [
  ...
  { grp:'2〜3ヶ月前', text:'人気店の予約方法を確認（Chin ChinはOpenTable、Cumulusは公式サイト・電話。どちらもウォークイン可）' },
  ...
  { grp:'1週間前', text:'Chin Chin（9/21 18:00）とCumulus（9/22 18:00）を予約（OpenTable／公式サイト）。移動疲れの日に並ばずに済む' }
];
