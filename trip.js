  ...
  days: [
    { n:1, date:'9/20', wd:'日', title:'成田を発って、南半球へ',
      ...
      sched:[
        ...
        { t:'13:38', h:'N\'EX 31号 新宿発 → 空港第2ビル', d:'約81分・14:59着でT2直結。指定席 4号車1番C/D（購入済み）',
          tips:[
            '特急券はチケットレス（何も見せなくてよい）。運賃は別なのでSuicaのまま改札を通る',
            '乗り遅れても14:08発（15:23着）で間に合う。焦らない',
            '荷物は座席背後のスペースか荷物置場へ。ワイヤー錠が付けられる' ] },
        { t:'14:59', h:'成田空港 第2ターミナル着', d:'空港第2ビル駅からT2直結。JALカウンターでチェックイン・荷物預け・Wi-Fi受取',
    ...
    { n:5, date:'9/24', wd:'木', title:'ブルーマウンテンズと動物たちの日',
      ...
      sched:[
        ...
        { t:'14:20', h:'エコーポイント展望台', d:'スリーシスターズの大展望', sv:{ lat:-33.7322, lng:150.312, label:'エコーポイント展望台', note:'バスを降りた先の広場。売店（インフォメーション）の右奥に手すりがあり、その先がスリーシスターズの展望台' },
