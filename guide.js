...
var GUIDE_GO = [
  ...
  { t:'17:00', h:'保安検査 → 出国審査', d:'この順。出国審査は顔認証で約10秒・会話なし。スタンプは押されないのが正常。ゲート集合は18:10',
    steps:[ '成田T2はスマートレーン＝数人が同時にトレーへ載せる並列式。CT型のレーンならPC・液体は出さずカバンごと1トレーでOK（レーン手前の表示に従う）',
...
function renderGuidePage() {
  ...
  h += jmpHTML([['jg-go','出発日'],['jg-back','帰国日'],['jg-hb','作法帖'],['jg-sos','もしも'],['jg-sv','予行演習'],['jg-lib','誌面']]);
