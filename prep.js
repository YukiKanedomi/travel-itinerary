...
var PREP_TODO = [
  ...
  { grp:'1週間前', text:'試しパッキングして荷物はかりで計量（受託23kg・国内線の機内持込7kg）' },
...
var PREP_KB = [
  ...
  { title:'受託手荷物とロストバゲージ対策', body:'JAL国際線はエコノミー23kg×2個。<b>豪州国内線VA859は受託1個23kgをeチケットで確認済み</b>（機内持込は7kgまで）。対策は<b>夫婦で服を半分ずつ交換して詰める</b>ことと、AirTagの携行。<b>受け取り時にその場で破損を確認</b>（持ち帰ってからでは申告できない）。到着ごとに古い紙タグを剥がすと誤搭載を防げる。' }
];
