  ...
  days: [
    ...
    { n:2, date:'9/21', wd:'月', title:'メルボルン到着、カフェの街へ',
      ...
      sched:[
        ...
        { t:'7:00', h:'SkyBusで市内へ', d:'真っ赤な2階建て。全便サザンクロス駅行き・約30分・$25.90/人', sv:{ lat:-37.6698, lng:144.8435, label:'メルボルン空港 T1〜T3前の車寄せ（SkyBus乗り場・おおよそ）' },
          steps:[
        ...
        { t:'7:45', h:'インターコンチに荷物預け', d:'チェックインは15時。フロントに荷物を預けて身軽に', sv:{ lat:-37.81825, lng:144.95799, label:'インターコンチネンタル（495 Collins St）の入口' },
        ...
        { t:'8:15', h:'朝食 — Lune Croissanterie', d:'世界最高峰のクロワッサンとフラットホワイト。早朝到着の今だけ行列前に入れる', sv:{ lat:-37.8156, lng:144.969, label:'Lune CBD（161 Collins St・Russell St側の入口）' },
        ...
        { t:'13:00', h:'ランチ — Il Solito Posto', d:'Collins St東端・地下の隠れ家イタリアン。パスタ・リゾット・モクテル', sv:{ lat:-37.8131, lng:144.9725, label:'Il Solito Posto（113 Collins St・George Parade側の地下入口）' },
        ...
        { t:'18:00', h:'ディナー — Chin Chin', d:'モダンタイの人気店。予約せずウォークインで。17:30に着くと待ちが短く、回転は早い。辛さ調整可（mildで）', sv:{ lat:-37.81569, lng:144.97042, label:'Chin Chin（125 Flinders Lane）' },
    ...
    { n:4, date:'9/23', wd:'水', title:'メルボルンの朝、シドニーの夜',
      ...
      sched:[
        ...
        { t:'14:15', h:'T3でチェックイン（ヴァージン専用）', d:'T4はJetstar等なので注意', sv:{ lat:-37.6702, lng:144.8437, label:'メルボルン空港 T3（ヴァージン）入口付近・おおよそ' },
        ...
        { t:'18:15', h:'リッジスにチェックイン', d:'直結のColesで滞在中の水とTimTamを調達', sv:{ lat:-33.87715, lng:151.20755, label:'リッジス ワールドスクエア（389 Pitt St）の入口' },
    ...
    { n:5, date:'9/24', wd:'木', title:'ブルーマウンテンズと動物たちの日',
      ...
      sched:[
        ...
        { t:'8:25', h:'ヒルトン ロビー集合', d:'8:30出発。遅刻するとツアーに乗れません', hard:true, sv:{ lat:-33.87182, lng:151.2076, label:'ヒルトン シドニー正面（488 George St・QVBの斜向かい）' },
          tips:[
        ...
        { t:'14:20', h:'エコーポイント展望台', d:'スリーシスターズの大展望', sv:{ lat:-33.7322, lng:150.312, label:'エコーポイント展望台' },
    ...
    { n:6, date:'9/25', wd:'金', title:'ハーバーの街を歩き尽くす最終日',
      ...
      sched:[
        ...
        { t:'15:00', h:'QVBで本気のお土産', d:'T2の紅茶・カンガルーグッズ・R.M.Williams。一段上の土産をここで。AesopはQVB内にはなく、188 Pitt St（徒歩3分）', sv:{ lat:-33.87144, lng:151.20667, label:'QVB（George St側）' },
        ...
        { t:'18:30', h:'ディナー — Opera Bar', d:'オペラハウス直下の絶景テラス。予約不要。ピザ＋モクテルで最後の夜に乾杯', sv:{ lat:-33.8578, lng:151.2142, label:'オペラハウス下のコンコース（Opera Bar）' },
    ...
    { n:7, date:'9/26', wd:'土', title:'南十字星に手を振って、帰国',
      ...
      sched:[
        ...
        { t:'6:00', h:'T1 JALカウンター＆TRS', d:'空港の推奨は国際線3時間前。チェックイン後、TRS対象があれば保安検査後のカウンターへ', sv:{ lat:-33.93497, lng:151.16587, label:'シドニー空港 T1 出発フロアの車寄せ' },
