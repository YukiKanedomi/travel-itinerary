...
var TRIP = {
  ...
  days: [
    { n:1, date:'9/20', wd:'日', title:'成田を発って、南半球へ',
      ...
      voucher:null,
      sched:[
        { t:'12:20', h:'橋本駅発 — 京王特急 新宿行き', d:'橋本始発なので座れる。新宿まで約45分・430円',
          steps:[
            '12:20頃発の特急 新宿行きに乗車（橋本始発）',
            '13:05頃 新宿着。京王線改札を出てJR南口方面へ',
            'スーツケース連れの乗り換えは15分見る。N\'EXは5・6番線' ],
          tips:[
            'N\'EXの指定席はえきねっとで事前購入済みのこと（当日券売機に並ばない）',
            '京王が止まったら控え：JR横浜線で横浜へ → N\'EX横浜発（4,370円）' ] },
        { t:'13:38', h:'N\'EX 新宿発 → 空港第2ビル', d:'約75分・3,250円。14:54着でT2直結',
          tips:[
