    ...
    { n:2, date:'9/21', wd:'月', title:'メルボルン到着、カフェの街へ',
      ...
      sched:[
        ...
        { t:'13:00', h:'ランチ — Il Solito Posto', d:'Collins St東端・地下の隠れ家イタリアン。パスタ・リゾット・モクテル', sv:{ lat:-37.8131, lng:144.9725, label:'Il Solito Posto（113 Collins St・George Parade側の地下入口）', note:'George Parade 側。木の壁のロビーが入口で、階段で地下へ降りる。左隣の車路は駐車場なので入らない' },
          ...
          tips:[ '疲れていたら気軽な代案でよい。近い順に：Degraves St／Centre Place（Flinders St駅そばのカフェ路地・サンドイッチやトースト）、Hardware Lane（パスタとピザの路地・呼び込みあり）、Melbourne Central か Emporium のフードコート（席が取りやすい）',
            '並ばず確実なチェーン：Grill\'d（バーガー）、Schnitz（シュニッツェル）、Guzman y Gomez（メキシカン）、Roll\'d（ベトナム麺・ロール）。どれも貝・甲殻類を避けやすい',
            '一番楽なのは Coles／Woolworths でサンドイッチと果物を買い、Federation Square のベンチで食べる。ホテルに荷物を預けた後なら身軽' ] },
