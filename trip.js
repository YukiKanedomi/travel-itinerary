  ...
  days: [
    ...
    { n:6, date:'9/25', wd:'金', title:'ハーバーの街を歩き尽くす最終日',
      ...
      sched:[
        ...
        { t:'15:00', h:'QVBで本気のお土産', d:'T2の紅茶・カンガルーグッズ・R.M.Williams。一段上の土産をここで。AesopはQVB内にはなく、188 Pitt St（徒歩3分）',
    ...
    { n:7, date:'9/26', wd:'土', title:'南十字星に手を振って、帰国',
      ...
      sched:[
        ...
        { t:'6:00', h:'T1 JALカウンター＆TRS', d:'空港の推奨は国際線3時間前。チェックイン後、TRS対象があれば保安検査後のカウンターへ',
